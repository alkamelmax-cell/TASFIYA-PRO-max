...
<head>
    ...
    <style>
        ...
        * {
        ...
        @page {
            size: A4 portrait;
            margin: 6mm 5mm 8mm 5mm; /* تقليل الهوامش لاستغلال المساحة بشكل أفضل */
        }
        ...
        .table {
            ...
            border-radius: 4px; /* تقليل الحواف المدورة */
            overflow: hidden;
    ...
    <div class="reconciliation-info">
        ...
        <div class="info-grid">
            <div class="info-item">
                ...
                <div class="info-value">${reconciliation.id}</div>
            </div>
            <div class="info-item">
