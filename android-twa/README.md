...
هذا المجلد يبني تطبيق Android حقيقي من تطبيق الويب باستخدام **Trusted Web Activity**. يفتح نفس تطبيق تصفية برو بملء الشاشة من Chrome عند توفره، ويحتوي أيضًا على WebView احتياطي داخل التطبيق حتى لا يغلق التطبيق إذا لم يكن Chrome أو موفر Custom Tabs متاحًا على الهاتف.
