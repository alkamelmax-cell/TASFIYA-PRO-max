        ...
        if (reconciliationData?.isCustomerStatement && textReceipt) {
            try {
                ...
                if (parsedStatement?.isStructuredStatement && parsedStatement.statementType === 'postpaid_net_balances') {
                    ...
                    const footerMm = 18;
                    return Math.round(clampHeightMm(headerMm + rowHeightMm + summaryMm + footerMm) * 1000);
                }
        ...
        try {
            ...
            const printOptions = {
                ...
                pageSize: {
                    ...
                    height: estimatedPageHeightMicrons  // ارتفاع متكيّف مع طول التقرير
                },
