function createEventListenersSetup(deps) {
  ...
  function setupEventListeners() {
    ...
    const detailedBranchFilter = doc.getElementById('detailedBranchFilter');
    if (detailedBranchFilter && typeof handlers.handleDetailedBranchFilterChange === 'function') {
      detailedBranchFilter.addEventListener('change', handlers.handleDetailedBranchFilterChange);
    }
    const detailedFeesMode = doc.getElementById('detailedFeesMode');
    if (detailedFeesMode && typeof handlers.handleDetailedReportFeesModeChange === 'function') {
      detailedFeesMode.addEventListener('change', handlers.handleDetailedReportFeesModeChange);
    }
    ...
    const addBankFeeRuleBtn = doc.getElementById('addBankFeeRuleBtn');
    if (addBankFeeRuleBtn && typeof handlers.handleAddBankFeeRuleRow === 'function') {
      addBankFeeRuleBtn.addEventListener('click', handlers.handleAddBankFeeRuleRow);
    }
    const bankFeeRulesTableBody = doc.getElementById('bankFeeRulesTableBody');
    if (bankFeeRulesTableBody && typeof handlers.handleBankFeeRulesTableClick === 'function') {
      bankFeeRulesTableBody.addEventListener('click', handlers.handleBankFeeRulesTableClick);
    }
    ...
    if (typeof handlers.initializeAutoBackupStatusListener === 'function') {
      handlers.initializeAutoBackupStatusListener();
    }
