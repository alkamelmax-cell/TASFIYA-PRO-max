...
function createReconciliationDataEntryHandlers(deps) {
  ...
  const customerCodeHelpers = createCustomerCodeHelpers({
    ipcRenderer,
    logger
  });
  createCustomerCodeAutoFill({
    ...
    resolveBranchId: () => shared.resolveReconciliationBranchId(),
    loadCustomersForDropdowns
  }).bindPairs([
    { nameInputId: 'customerName', codeInputId: 'customerCode' },
    { nameInputId: 'customerReceiptName', codeInputId: 'customerReceiptCode' }
  ]);
  ...
  const salesHandlers = createReconciliationDataEntrySalesHandlers({
    ...
    resolveCustomerIdentity: customerCodeHelpers.resolveCustomerIdentity,
    getPostpaidSales,
    setPostpaidSales,
    getCustomerReceipts,
    setCustomerReceipts
