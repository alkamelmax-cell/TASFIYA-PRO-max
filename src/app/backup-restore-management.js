...
function createBackupRestoreManagementHandlers(deps) {
  ...
  return {
    ...
    initializeAutoBackupStatusListener: settingsActions.initializeAutoBackupStatusListener,
    updateAutoBackupStatusFromCheckResult: settingsActions.updateAutoBackupStatusFromCheckResult,
