...
async function createDefaultSettings() {
    ...
    try {
        ...
        const defaultSettings = [
            ...
            { category: 'reports', key: 'detailed_atm_fees_mode_default', value: 'without_fees' },
            { category: 'reports', key: 'detailed_atm_fees_mode_last', value: 'without_fees' },
            { category: 'reports', key: 'bank_fee_rules_json', value: '{"rules":[]}' },
