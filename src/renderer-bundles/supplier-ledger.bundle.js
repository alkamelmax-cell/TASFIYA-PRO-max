/* eslint-disable */
// Auto-generated renderer bundle for supplier-ledger.
...
(function bootstrapRendererBundle(globalObject) {
  const modules = {
    ...
    "src/supplier-ledger.js": function rendererModule(module, exports, require) {
      // ===================================================
      // 🏪 Supplier Ledger
      // ===================================================
      ...
      (() => {
        ...
        function buildSupplierLedgerQuery(filters) {
          ...
          const subManual = `
            SELECT
              ...
              COALESCE(b.branch_name, 'غير محدد') AS t_branch_name
            FROM manual_supplier_transactions ms
        ...
        function updateSupplierLedgerSelectionUi() {
          ...
          if (undoBtn) {
            ...
            const createdAtText = latestUndoableSupplierMerge?.created_a
  ...
  const resolutionMap = {
    "src/renderer-ipc.js": {},
    "src/supplier-ledger.js": {"./renderer-ipc":"src/renderer-ipc.js"}
  };
  ...
  requireModule("src/supplier-ledger.js");
